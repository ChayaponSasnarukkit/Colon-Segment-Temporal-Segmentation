...
def main():
    ...
    cfg_seed = hparams.get("seed", 5856267)
    ...
    cfg_save_dir = hparams.get("save_dir", f"/project/lt200353-pcllm/3d_report_gen/cas_colon/mid_8tunedebug_seed5856267_full_shuffle/fold{cfg_fold}/")
