...
#SBATCH -t 4:20:00                     # Specify maximum time limit (hour: minute: second)
...
srun --export=ALL,LD_LIBRARY_PATH=$LD_LIBRARY_PATH,LD_PRELOAD=$LD_PRELOAD python train_cas_colon_mid.py 
