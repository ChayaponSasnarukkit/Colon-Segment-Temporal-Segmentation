...
from model.ContextMamba import ContextMambav2ForRealColon, ContextMambaCmeRT
...
def main():
    ...
    full_model = ContextMambav2ForRealColon(
        ...
        target_fps=5, context_fps=5, query_fps=5, 
    ...
    class_weights_tensor = train_dataset.compute_weights()
