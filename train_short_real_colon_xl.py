...
from model.ContextMamba import ContextMambaExtraLargeForRealColon, ContextMambaCmeRT
...
def main():
    ...
    if USE_CMERT_HEAD:
        ...
        full_model = ContextMambaExtraLargeForRealColon(base_model=model.backbone, d_model=1024, num_classes=num_action_classes, num_future=3, frames_per_query=[10, 6], compression_ratio=60.0).to(device)
