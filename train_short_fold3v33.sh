...
#SBATCH -t 08:30:00                     # Specify maximum time limit (hour: minute: second)
#SBATCH -A pv927002               # Specify project name
...
srun --export=ALL,LD_LIBRARY_PATH=$LD_LIBRARY_PATH,LD_PRELOAD=$LD_PRELOAD python train_short_fold3v33.py
