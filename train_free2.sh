...
#SBATCH -t 1:20:00                     # Specify maximum time limit (hour: minute: second)
...
srun --export=ALL,LD_LIBRARY_PATH=$LD_LIBRARY_PATH,LD_PRELOAD=$LD_PRELOAD python train_real_colon.py --config 2config.json
