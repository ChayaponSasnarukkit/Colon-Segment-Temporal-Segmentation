...
#SBATCH -t 02:00:00                     # Specify maximum time limit (hour: minute: second)
...
srun --export=ALL,LD_LIBRARY_PATH=$LD_LIBRARY_PATH,LD_PRELOAD=$LD_PRELOAD python train_short_real_colon_no_jitter.py --config short_config.json
