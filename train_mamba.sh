...
#SBATCH -t 2:30:00                     # Specify maximum time limit (hour: minute: second)
...
srun --export=ALL,LD_LIBRARY_PATH=$LD_LIBRARY_PATH,LD_PRELOAD=$LD_PRELOAD python real_train_context_mamba_joint_v2.py
