...
def main():
    ...
    cfg_save_dir = hparams.get("save_dir", f"/project/lt200353-pcllm/3d_report_gen/cas_colon/full_shuffle/fold{cfg_fold}/")
    ...
    cfg_context_fps = hparams.get("context_fps", 5)
    cfg_query_fps = hparams.get("query_fps", 30)
    cfg_compression_ratio = hparams.get("compression_ratio", 300.0)
    cfg_frames_per_query = hparams.get("frames_per_query", [20, 15])
